    ...
    def __init__(self, data_folder, data_name, flag, user_dict, user_id, transform, FineGrain):
        ...
        if flag == "train":
            for i in data_distribution:
                ...
                if self.FineGrain == 1:
                    self.h = h5py.File(os.path.join(data_train_path,  '_IMAGES_' + data_name + 'RID_processed_1to1.hdf5'), 'r')
            ...
            for i in data_distribution:
                ...
                # Open hdf5 file where images are stored
                self.h = h5py.File(os.path.join(data_train_path,  '_IMAGES_' + data_name + 'RID_processed_1to1_test.hdf5'), 'r')
                self.imgs.extend(self.h['images'])
