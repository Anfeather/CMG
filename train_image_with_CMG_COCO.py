...
def main():
    ...
    parser.add_argument("--data-dir", type=str, default="./non_iid_MSCOCO_train_30_50_5images/")
    ...
    train_loader, test_loader, _ = data.MSCOCO_image_with_CMG_CMER("ssl",args.data_dir, user_dict, batch_size=args.batch_size, normalize=args.normalize, size=args.size,F="N",FineGrain=1)
    infer_train_loader, infer_test_loader, _ = data.MSCOCO_image_with_CMG_CMER("base",args.data_dir, user_dict, batch_size=args.batch_size, normalize=args.normalize, size=args.size)
    ood_loader,_,_ = data.MSCOCO_image_with_CMG_CMER("base",args.data_dir, user_dict, batch_size=args.batch_size, normalize=args.normalize, size=args.size, F = "OOD")
